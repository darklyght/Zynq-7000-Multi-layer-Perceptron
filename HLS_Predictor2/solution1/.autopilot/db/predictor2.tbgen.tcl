set C_TypeInfoList {{ 
"predictor2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"bram": [[], {"array": [ {"scalar": "int"}, [2048]]}] }],[],""]
}}
set moduleName predictor2
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "BUS_CTRL", "role": "AWADDR" },"address":[{"name":"predictor2","role":"start","value":"0","valid_bit":"0"},{"name":"predictor2","role":"continue","value":"0","valid_bit":"4"},{"name":"predictor2","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_BUS_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "BUS_CTRL", "role": "ARADDR" },"address":[{"name":"predictor2","role":"start","value":"0","valid_bit":"0"},{"name":"predictor2","role":"done","value":"0","valid_bit":"1"},{"name":"predictor2","role":"idle","value":"0","valid_bit":"2"},{"name":"predictor2","role":"ready","value":"0","valid_bit":"3"},{"name":"predictor2","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.predictor2_BUS_CTRL_s_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.predictor2_mul_32cud_U0", "Parent" : "0"}]}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "23682", "Max" : "23682"}
	, {"Name" : "Interval", "Min" : "23683", "Max" : "23683"}
]}
