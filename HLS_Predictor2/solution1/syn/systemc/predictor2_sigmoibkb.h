...
#ifndef __predictor2_sigmoibkb_H__
#define __predictor2_sigmoibkb_H__
...
struct predictor2_sigmoibkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(predictor2_sigmoibkb_ram) {
...
SC_MODULE(predictor2_sigmoibkb) {
...
predictor2_sigmoibkb_ram* meminst;


SC_CTOR(predictor2_sigmoibkb) {
meminst = new predictor2_sigmoibkb_ram("predictor2_sigmoibkb_ram");
