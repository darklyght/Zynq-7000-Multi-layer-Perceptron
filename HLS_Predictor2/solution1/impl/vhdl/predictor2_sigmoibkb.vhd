...
entity predictor2_sigmoibkb_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 13; 
...
architecture rtl of predictor2_sigmoibkb_rom is 
...
entity predictor2_sigmoibkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of predictor2_sigmoibkb is
    component predictor2_sigmoibkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    predictor2_sigmoibkb_rom_U :  component predictor2_sigmoibkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
