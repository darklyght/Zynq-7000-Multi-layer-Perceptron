...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module predictor3_sigmoibkb_rom (
...
initial begin
    $readmemh("./predictor3_sigmoibkb_rom.dat", ram0);
    $readmemh("./predictor3_sigmoibkb_rom.dat", ram1);
end
...
predictor3_sigmoibkb_rom predictor3_sigmoibkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
