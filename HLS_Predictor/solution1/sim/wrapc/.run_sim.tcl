...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "predictor.autotvin.dat"
	set constFileTvOut       "predictor.autotvout.dat"
	set constFileHdlTvIn     "predictor.autohdltvin.dat"
	set constFileHdlTvOut    "predictor.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
