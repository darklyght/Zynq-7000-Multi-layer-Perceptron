...
if {[file isfile predictor.autotvin.dat]} {
	file delete -force predictor.autotvin.dat
}

if {[file isfile predictor.autotvout.dat]} {
	file delete -force predictor.autotvout.dat
}
