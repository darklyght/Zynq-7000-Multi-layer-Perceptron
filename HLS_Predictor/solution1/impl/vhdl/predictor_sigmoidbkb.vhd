...
entity predictor_sigmoidbkb_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 13; 
...
architecture rtl of predictor_sigmoidbkb_rom is 
...
entity predictor_sigmoidbkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of predictor_sigmoidbkb is
    component predictor_sigmoidbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    predictor_sigmoidbkb_rom_U :  component predictor_sigmoidbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
